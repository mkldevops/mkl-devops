      ...
      <div id="features" className="custom-screen text-gray-600">
        <ul className="grid gap-x-12 gap-y-8 sm:grid-cols-2 lg:grid-cols-3">
          <li className="space-y-3">
            ...
            <p>
              Nous accordons une importance primordiale à la qualité du produit.
              En tant qu&apos;agence de développement de produits numériques,
              nous croyons en un logiciel esthétique.
            </p>
          </li>
          <li className="space-y-3">
            <div className="w-12 h-12 border text-indigo-600 rounded-full flex items-center justify-center">
            ...
            <p>
              Nous adoptons les technologies les plus avancées, innovantes et
              sécurisées pour concevoir des produits d&apos;exception sur le
              web, répondant ainsi aux attentes les plus exigeantes de nos
              clients. Notre engagement envers l&apos;excellence et la modernité
              place vos projets au cœur de l&apos;innovation digitale.
            </p>
          </li>
          <li className="space-y-3">
            <div className="w-12 h-12 border text-indigo-600 rounded-full flex items-center justify-center">
            ...
            <p>
              À l&apos;avant-garde de la sécurité logicielle, notre vocation est
              de redéfinir les normes en démocratisant l&apos;accès à une
              protection informatique de haut niveau. Nous nous engageons à vous
              fournir des solutions de sécurité innovantes, conçues pour
              sécuriser vos systèmes et données avec une efficacité et une
              facilité d&apos;utilisation inégalées.
            </p>
          </li>
        </ul>
      </div>
